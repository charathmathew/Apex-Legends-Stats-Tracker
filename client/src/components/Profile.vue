                ...
                <div>
                    <ul>
                        ...
                        <li v-if="profileData.segments[0].stats.rankScore"> 
                            <h4>Rank</h4>
                            <p>{{profileData.segments[0].stats.rankScore.metadata.rankName}}</p>
                            <p>RP: {{profileData.segments[0].stats.rankScore.displayValue}}</p>
                            <img :src= profileData.segments[0].stats.rankScore.metadata.iconUrl alt="">
                        </li>
                        <li v-if="profileData.segments[0].stats.season5Wins"> 
                            <h4>Season 5 Wins</h4>
                            <p>{{profileData.segments[0].stats.season5Wins.displayValue}}</p>
                            <span>Percentile - {{profileData.segments[0].stats.season5Wins.percentile}}%</span>
                        </li>
